...
parser.add_argument("--data_path", type=str, default="./real", help='path to training data')
parser.add_argument("--save_path", type=str, default="./results/Rainreal", help='path to save results')
parser.add_argument("--save_path1", type=str, default="./results/Rainreal-1", help='path to save results')
parser.add_argument("--save_path2", type=str, default="./results/Rainreal-2", help='path to save results')
