...
parser.add_argument("--save_path1", type=str, default="./input/Rain100H-1", help='path to save results')
parser.add_argument("--save_path2", type=str, default="./input/Rain100H-2", help='path to save results')
